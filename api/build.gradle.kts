...
repositories {
    // mavenLocal() first for SNAPSHOT dependencies (like person-api)
    mavenLocal()
    mavenCentral()
}
...
dependencies {
    // Use dependency substitution from composite build if available, otherwise fallback to mavenLocal()
